      ...
      <div className={`nav w-[31%] backdrop-blur-[10px] h-[100%] fixed top-[0px] border ${navbarOpen ? 'block' : 'hidden'}`}>
        <nav>
          ...
          <ul className=' w-[80%] m-auto gap-2 h-[50px] grid items-center justify-center'>
            ...
            {user && user.role == 'bekzod' && <li className='text-[700] rounded-[20px] border w-[150%] bg-red-400 border-black mt-[85px] h-[50px] flex items-center justify-center text-black bg-blue '>
