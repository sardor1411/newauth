...
const db1 = getFirestore(app); // Firestore instance
const storage1 = getStorage(app); // Storage instance
const auth1 = getAuth(app); // Authentication instance

export { db1, storage1, auth1 }; // Export auth1
