  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-[50px]">
        {box.map((mall) => (
          <div className="border border-black w-[65%] max-h-full text-center m-auto rounded-md h-auto mt-6 shadow-lg" key={mall.id}>
            <div className="box p-4">
              <img className="w-full h-[260px] object-cover rounded-t-md" src={mall.img} alt={mall.title} />
